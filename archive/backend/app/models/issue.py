...
class Issue(Base):
    ...
    # Relationships
    material: Mapped["Material"] = relationship("Material", back_populates="issues", lazy="joined")
    location: Mapped["Location"] = relationship("Location", back_populates="issues", lazy="joined")
